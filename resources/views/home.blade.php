...
<div class="blog-card spring-fever">
  <div class="title-content">
    <h3>{{ __('SPRING FEVER') }}</h3>
    <hr />
    <div class="intro">{{ __('Yllamco laboris nisi ut aliquip ex ea commodo.') }}</div>
  </div><!-- /.title-content -->
  <div class="card-info">
   {{ __(' Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim.') }}
  </div><!-- /.card-info -->
  <div class="utility-info">
    <ul class="utility-list">
      <li class="comments">{{ __('12') }}</li>
      <li class="date">{{ __('03.12.2015') }}</li>
    </ul>
  </div><!-- /.utility-info -->
  <!-- overlays -->
